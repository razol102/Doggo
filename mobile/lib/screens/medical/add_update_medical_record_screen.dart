...
// import 'package:mobile/utils/app_colors.dart';
// import 'package:mobile/services/validation_methods.dart';
// import '../../common_widgets/round_textfield.dart';  // Import the RoundTextField
//
// class AddUpdateMedicalRecordScreen extends StatefulWidget {
//   static const String routeName = "/AddUpdateMedicalRecordScreen";
//
...
//               children: [
//                 RoundTextField(
//                   textEditingController: _vetNameController,
//                   hintText: 'Vet Name',
//                   icon: 'assets/icons/vet_icon.png',  // Replace with the correct path
//                   textInputType: TextInputType.text,
//                   errorText: ValidationMethods.validateNotEmpty(_vetNameController.text, 'Vet Name'),
//                 ),
//                 const SizedBox(height: 16),
//                 RoundTextField(
//                   textEditingController: _addressController,
//                   hintText: 'Address',
//                   icon: 'assets/icons/location_icon.png',  // Replace with the correct path
//                   textInputType: TextInputType.text,
//                   errorText: ValidationMethods.validateNotEmpty(_addressController.text, 'Address'),
//                 ),
//                 const SizedBox(height: 16),
//                 RoundTextField(
//                   textEditingController: _timeController,
//                   hintText: 'Time',
//                   icon: 'assets/icons/time_icon.png',  // Replace with the correct path
...
//                   ),
//                   errorText: ValidationMethods.validateNotEmpty(_timeController.text, 'Time'),
//                 ),
//                 const SizedBox(height: 16),
//                 RoundTextField(
//                   textEditingController: _descriptionController,
//                   hintText: 'Description',
//                   icon: 'assets/icons/description_icon.png',  // Replace with the correct path
//                   textInputType: TextInputType.multiline,
//                   errorText: ValidationMethods.validateNotEmpty(_descriptionController.text, 'Description'),
//                 ),
//                 const SizedBox(height: 24),
//                 RoundGradientButton(
